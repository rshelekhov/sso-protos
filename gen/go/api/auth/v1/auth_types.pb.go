...
func (x *UserDeviceData) GetVersion() isUserDeviceData_Version {
	if x != nil {
		return x.Version
	}
	return nil
...
func (x *UserDeviceData) GetAppVersion() string {
	if x != nil {
		if x, ok := x.Version.(*UserDeviceData_AppVersion); ok {
			return x.AppVersion
		}
	}
	return ""
...
func (x *UserDeviceData) GetBrowserVersion() string {
	if x != nil {
		if x, ok := x.Version.(*UserDeviceData_BrowserVersion); ok {
...
const file_api_auth_v1_auth_types_proto_rawDesc = "" +
	"\n" +
	"\x1capi/auth/v1/auth_types.proto\x12\vapi.auth.v1\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xf3\x01\n" +
	"\x0eUserDeviceData\x12%\n" +
	"\n" +
	"user_agent\x18\x01 \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\tuserAgent\x12\x1a\n" +
	"\x02ip\x18\x02 \x01(\tB\n" +
	"\xbaH\a\xc8\x01\x01r\x02p\x01R\x02ip\x12>\n" +
	"\bplatform\x18\x03 \x01(\x0e2\x15.api.auth.v1.PlatformB\v\xbaH\b\xc8\x01\x01\x82\x01\x02\x10\x01R\bplatform\x12!\n" +
	"\vapp_version\x18\x04 \x01(\tH\x00R\n" +
	"appVersion\x12)\n" +
	"\x0fbrowser_version\x18\x05 \x01(\tH\x00R\x0ebrowserVersionB\x10\n" +
	"\aversion\x12\x05\xbaH\x02\b\x01\"\xf7\x02\n" +
	"\tTokenData\x12!\n" +
	...
	"\thttp_only\x18\x06 \x01(\bR\bhttpOnly\x12Y\n" +
	"\x11additional_fields\x18\a \x03(\v2,.api.auth.v1.TokenData.AdditionalFieldsEntryR\x10additionalFields\x1aC\n" +
	...
	"\x10PLATFORM_ANDROID\x10\x03B\x92\x01\n" +
	"\x0fcom.api.auth.v1B\x0eAuthTypesProtoP\x01Z!rshelekhov.sso.api.auth.v1;authv1\xa2\x02\x03AAX\xaa\x02\vApi.Auth.V1\xca\x02\vApi\\Auth\\V1\xe2\x02\x17Api\\Auth\\V1\\GPBMetadata\xea\x02\rApi::Auth::V1b\x06proto3"

var (
	file_api_auth_v1_auth_types_proto_rawDescOnce sync.Once
	file_api_auth_v1_auth_types_proto_rawDescData []byte
)

func file_api_auth_v1_auth_types_proto_rawDescGZIP() []byte {
	file_api_auth_v1_auth_types_proto_rawDescOnce.Do(func() {
		file_api_auth_v1_auth_types_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_api_auth_v1_auth_types_proto_rawDesc), len(file_api_auth_v1_auth_types_proto_rawDesc)))
	})
...
func file_api_auth_v1_auth_types_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_api_auth_v1_auth_types_proto_rawDesc), len(file_api_auth_v1_auth_types_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,

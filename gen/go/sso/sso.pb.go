...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x65, 0x6e, 0x44, 0x61, 0x74, 0x61, 0x22, 0x95, 0x01, 0x0a, 0x0c, 0x4c, 0x6f, 0x67, 0x69, 0x6e,
	...
	0x61, 0x74, 0x61, 0x52, 0x09, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x44, 0x61, 0x74, 0x61, 0x22, 0x64,
	...
	0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x61, 0x70, 0x70, 0x49, 0x64, 0x22, 0x61,
	...
	0x52, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x12, 0x38, 0x0a, 0x09, 0x75, 0x70, 0x64, 0x61, 0x74,
	...
	0x02, 0x38, 0x01, 0x22, 0x07, 0x0a, 0x05, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x32, 0xf1, 0x03, 0x0a,
...
var file_sso_sso_proto_depIdxs = []int32{
	...
	20, // 10: auth.TokenData.expiresAt:type_name -> google.protobuf.Timestamp
	18, // 11: auth.TokenData.additional_fields:type_name -> auth.TokenData.AdditionalFieldsEntry
	...
	5,  // 15: auth.Auth.Logout:input_type -> auth.LogoutRequest
	...
	14, // 20: auth.Auth.DeleteUser:input_type -> auth.DeleteUserRequest
	17, // 21: auth.Auth.RegisterApp:output_type -> auth.Empty
	2,  // 22: auth.Auth.RegisterUser:output_type -> auth.RegisterUserResponse
	4,  // 23: auth.Auth.Login:output_type -> auth.LoginResponse
	17, // 24: auth.Auth.Logout:output_type -> auth.Empty
	7,  // 25: auth.Auth.Refresh:output_type -> auth.RefreshResponse
	9,  // 26: auth.Auth.GetJWKS:output_type -> auth.GetJWKSResponse
	12, // 27: auth.Auth.GetUser:output_type -> auth.GetUserResponse
	17, // 28: auth.Auth.UpdateUser:output_type -> auth.Empty
	17, // 29: auth.Auth.DeleteUser:output_type -> auth.Empty

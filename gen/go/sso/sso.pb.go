...
func (x *LogoutResponse) GetTokenData() *TokenData {
	if x != nil {
		return x.TokenData
	}
	return nil
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x22, 0x3f, 0x0a, 0x0e, 0x4c, 0x6f, 0x67, 0x6f, 0x75, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	...
	0x61, 0x22, 0x3f, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75,
	...
	0x61, 0x69, 0x6c, 0x12, 0x38, 0x0a, 0x09, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74,
	...
	0x20, 0x01, 0x28, 0x05, 0x52, 0x05, 0x61, 0x70, 0x70, 0x49, 0x64, 0x22, 0x14, 0x0a, 0x12, 0x55,
	...
	0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x05, 0x61, 0x70, 0x70, 0x49, 0x64, 0x12, 0x3c, 0x0a,
	0x0e, 0x75, 0x73, 0x65, 0x72, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x44, 0x61, 0x74, 0x61, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x55, 0x73, 0x65,
	0x72, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x44, 0x61, 0x74, 0x61, 0x52, 0x0e, 0x75, 0x73, 0x65,
	0x72, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x44, 0x61, 0x74, 0x61, 0x22, 0x14, 0x0a, 0x12, 0x44,
	0x65, 0x6c, 0x65, 0x74, 0x65, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
	0x65, 0x22, 0x3e, 0x0a, 0x0e, 0x55, 0x73, 0x65, 0x72, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x44,
	...
	0x32, 0x9a, 0x03, 0x0a, 0x04, 0x41, 0x75, 0x74, 0x68, 0x12, 0x39, 0x0a, 0x08, 0x52, 0x65, 0x67,
...
var file_sso_sso_proto_goTypes = []interface{}{
	...
	nil,                           // 16: auth.TokenData.AdditionalFieldsEntry
...
var file_sso_sso_proto_depIdxs = []int32{
	...
	14, // 4: auth.RefreshRequest.userDeviceData:type_name -> auth.UserDeviceData
	15, // 5: auth.RefreshResponse.tokenData:type_name -> auth.TokenData
	14, // 6: auth.LogoutRequest.userDeviceData:type_name -> auth.UserDeviceData
	15, // 7: auth.LogoutResponse.tokenData:type_name -> auth.TokenData
	17, // 8: auth.GetUserResponse.updatedAt:type_name -> google.protobuf.Timestamp
	14, // 9: auth.DeleteUserRequest.userDeviceData:type_name -> auth.UserDeviceData
	17, // 10: auth.TokenData.expiresAt:type_name -> google.protobuf.Timestamp
	16, // 11: auth.TokenData.additional_fields:type_name -> auth.TokenData.AdditionalFieldsEntry
	0,  // 12: auth.Auth.Register:input_type -> auth.RegisterRequest
	2,  // 13: auth.Auth.Login:input_type -> auth.LoginRequest
	4,  // 14: auth.Auth.Refresh:input_type -> auth.RefreshRequest
	6,  // 15: auth.Auth.Logout:input_type -> auth.LogoutRequest
	8,  // 16: auth.Auth.GetUser:input_type -> auth.GetUserRequest
	10, // 17: auth.Auth.UpdateUser:input_type -> auth.UpdateUserRequest
	12, // 18: auth.Auth.DeleteUser:input_type -> auth.DeleteUserRequest
	1,  // 19: auth.Auth.Register:output_type -> auth.RegisterResponse
	3,  // 20: auth.Auth.Login:output_type -> auth.LoginResponse
	5,  // 21: auth.Auth.Refresh:output_type -> auth.RefreshResponse
	7,  // 22: auth.Auth.Logout:output_type -> auth.LogoutResponse
	9,  // 23: auth.Auth.GetUser:output_type -> auth.GetUserResponse
	11, // 24: auth.Auth.UpdateUser:output_type -> auth.UpdateUserResponse
	13, // 25: auth.Auth.DeleteUser:output_type -> auth.DeleteUserResponse

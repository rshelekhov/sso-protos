...
var file_sso_sso_proto_rawDesc = string([]byte{
	...
	0x02, 0x38, 0x01, 0x32, 0xc5, 0x05, 0x0a, 0x04, 0x41, 0x75, 0x74, 0x68, 0x12, 0x42, 0x0a, 0x0b,
	...
	0x73, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x19, 0x5a, 0x17, 0x72,
	0x73, 0x68, 0x65, 0x6c, 0x65, 0x6b, 0x68, 0x6f, 0x76, 0x2e, 0x73, 0x73, 0x6f, 0x2e, 0x76, 0x31,
...
var file_sso_sso_proto_depIdxs = []int32{
	...
	21, // 21: auth.Auth.UpdateUser:input_type -> auth.UpdateUserRequest
	23, // 22: auth.Auth.DeleteUser:input_type -> auth.DeleteUserRequest
	1,  // 23: auth.Auth.RegisterApp:output_type -> auth.RegisterAppResponse
	3,  // 24: auth.Auth.RegisterUser:output_type -> auth.RegisterUserResponse
	5,  // 25: auth.Auth.VerifyEmail:output_type -> auth.VerifyEmailResponse
	7,  // 26: auth.Auth.Login:output_type -> auth.LoginResponse
	9,  // 27: auth.Auth.ResetPassword:output_type -> auth.ResetPasswordResponse
	11, // 28: auth.Auth.ChangePassword:output_type -> auth.ChangePasswordResponse
	15, // 29: auth.Auth.Refresh:output_type -> auth.RefreshResponse
	17, // 30: auth.Auth.GetJWKS:output_type -> auth.GetJWKSResponse
	13, // 31: auth.Auth.Logout:output_type -> auth.LogoutResponse
	22, // 32: auth.Auth.UpdateUser:output_type -> auth.UpdateUserResponse
	24, // 33: auth.Auth.DeleteUser:output_type -> auth.DeleteUserResponse
